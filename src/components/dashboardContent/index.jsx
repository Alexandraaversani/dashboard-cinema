    ...
    return (
        ...
        <div className={styles.summaryCards}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.cardChange + " " + styles.positive}>+12% em relação ao semestre anterior
            </div>
          </div>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.cardChange + " " + styles.negative}>-3% em relação à semana anterior
            </div>
          </div>
        </div>
        ...
        <div className={styles.additionalInfo}>
          <div className={styles.sessionBox}>
            ...
            <ul className={styles.sessionList}>
              <li>
                <span className={styles.sectionTime}>14:30</span>
              ...
              <li>
                <span className={styles.sectionTime}>15:00</span>
              ...
              <li>
                <span className={styles.sectionTime}>16:45</span>
              ...
              <li>
                <span className={styles.sectionTime}>19:00</span>
